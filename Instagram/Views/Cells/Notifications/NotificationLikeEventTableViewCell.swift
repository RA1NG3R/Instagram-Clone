...
//  Instagram
//
//  Created by Subodh Mahajan on 09/03/22.
//
...
class NotificationLikeEventTableViewCell: UITableViewCell {
    ...
    private let label: UILabel = {
        ...
        label.text = "@subodh liked your photo"
        return label
    }()
    ...
    override func layoutSubviews() {
        ...
        label.frame = CGRect(x: profileImageView.right+5, y: 0, width: width-size-profileImageView.width-16, height: contentView.height)
    }
